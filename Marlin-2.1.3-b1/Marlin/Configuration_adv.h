...
#define HOMING_BUMP_MM      { 5, 5, 2, 3, 3 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4, 3, 3 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
//money and power
  ...
  #define MANUAL_FEEDRATE { 1200, 900, 1300, 9000,9000 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
